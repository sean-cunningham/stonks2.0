...
class ContextService:
    ...
    def get_status(self) -> ContextStatusResponse:
        ...
        return ContextStatusResponse(
            ...
            expected_latest_completed_1m_start=readiness.expected_latest_completed_1m_start,
            stale_1m_reference_time=readiness.stale_1m_reference_time,
            stale_1m_seconds=readiness.stale_1m_seconds,
            stale_1m_boolean=readiness.stale_1m_boolean,
