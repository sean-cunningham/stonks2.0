"""Deterministic paper position open/close for Strategy 3 (0DTE micro impulse)."""
...
from app.services.strategy.strategy_three_spy_micro_impulse import STRATEGY3_ID
...
class StrategyThreePaperTradeService:
    STRATEGY_ID = STRATEGY3_ID
        ...
        *,
        ...
        try:
            exit_pol, sizing_pol = assign_exit_and_sizing_policies_v1(
                ...
                quantity=1,
                account_equity_usd=float(settings.PAPER_STRATEGY3_ACCOUNT_EQUITY_USD),
                entry_clock_utc=now,
            )
